...
public class CompoundInterest {
    ...
    static void printDollarFV(int targetYear, double returnRate,
                              double inflationRate) {
        double nominalDollarValue = Math.pow((1+returnRate/100), numYears(targetYear)); // replace 0 with your code
        double realDollarValue = nominalDollarValue*Math.pow(1-inflationRate/100, numYears(targetYear));    // replace 0 with your code
